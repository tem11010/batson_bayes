...
>>>>>>> 9839f2f339ee8cece9b1e487cc78e50eb05355ec
...
In future work we hope to examine data-driven approached to the selection of $\alpha$; where the degree of incompatibility can be estimated and used to inform the choice of the degree of discounting to apply to historical data. [editme - refs?] Knowing how to quantify incompatibility and how to specify and appropriate prior for  $\alpha$ is an area of active research [e.g., https://arxiv.org/abs/2206.04379, cite Eric] 
