...
The use of the power prior in this context allows lawyers to explicitly control the assumed degree of incompatibility between the current and historical trial data. Specifically, lower values (closer to 0) of the power prior parameter, $\alpha$, should be selected if incompatibility is expected to be high. Higher values (closer to 1) of the power prior parameter should be selected if incompatibility is expected to be low. Accordingly, the lawyer bringing the _Batson_ challenge, after choosing the value of $\alpha$, must be able to defend that choice as appropriately cooresponding to the likely degree of incompatibility between the current and historical strike data in the particular case. 
