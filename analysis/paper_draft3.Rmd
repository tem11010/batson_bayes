...
In future work we hope to examine data-driven approach to selecting $\alpha$; where the degree of incompatibility can be estimated and used to inform the choice of the degree of discounting to apply to historical data. Knowing how to quantify incompatibility and how to specify an appropriate prior for $\alpha$ is an area of active research [e.g., @Pawel2022] 
