...
By their choice of $\alpha$, the lawyer explicitly and transparently denotes the degree of weight placed on the historical strike data in the analysis. This transparency thwarts lawyer efforts to strategically select $\alpha$ values to prove or disprove illegal strike bias. Rather, at the key steps of the _Batson_ challenge process (Figure \@ref(fig:batsonworkflowfig)), the lawyers on both sides of a _Batson_ challenge know that the lawyers on either side can always directly and repeatedly assess how sensitive any bias inference is to the choice of $\alpha$. In any case, the choice of $\alpha$ cannot always determine whether a trial judge finds illegal bias, because no approach to using historical strike data has that ability.
