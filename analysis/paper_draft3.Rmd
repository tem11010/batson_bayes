...
```{r figbd9510, out.width = "95%", fig.cap = "Bias detection rates (proportion of simulations where 0 is excluded from the 95 percent credible interval of bias parameter) for simulations based on 10 strikes.", fig.align='center'}
