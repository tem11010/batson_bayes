...
The use of the power prior in this context allows the explicit control of the degree of incompatibility between the current and historical trial data. Specifically, lower values (closer to 0) of the power prior parameter, $\alpha$, should be selected when incompatibility is expected to be high, and higher values (closer to 1) of the power prior parameter selected when incompatibility is low. For now, the choice of alpha is placed in the hands of the user, who will need to be able to defend their choice when presenting a _Batson_ challenge before the court. 
