...
Similarly, although we did run simulations for when when $\alpha = 0$, Figures 2-4 do not depict the bias detection rate for that scenario, simply because that scenario is equivalent to evaluating bias detection with only strike data from the current trial (no historical strike data) -- a topic of prior papers [e.g. @Kadane2018a].
