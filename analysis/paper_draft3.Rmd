...
The use of the power prior in this context allows lawyers explicit control over the assumed degree of incompatibility between the current and historical trial data. Specifically, lower values (closer to 0) of the power prior parameter, $\alpha$, should be selected when incompatibility is expected to be high, and higher values (closer to 1) of the power prior parameter selected when incompatibility is low. Accordingly, the lawyer bringing the _Batson_ challenge chooses the value of $\alpha$ and must be able to explain and defend that choice as appropriately cooresponding to the likely degree of incompatibility between the current strike data and historical strike data available in the particular case. 
